...
//cblas_sgemv
    ...
    for(int i=0; i<1; i++) {
      //cblas_sgemv(CblasColMajor, CblasNoTrans, 16, 16, alpha, A, 16, X, 3, beta, Y, 2);
      //a4++;
    }
...
//cblas_sgemv_usermode
    ...
    for(int i=0; i<1; i++) {
      //cblas_sgemv_usermode(CblasColMajor, CblasNoTrans, 16, 16, alpha, A, 16, X, 3, beta, Y, 2, 4, 2);
    }
    
//cblas_sgemm
    //printf("result of cblas_sgemm\n");
    for(int i=0; i<1; i++) {
      cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 32, 32, 32, alpha, A, 32, B, 32, beta, C, 32);
      pimblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 32, 32, 32, alpha, A, 32, B, 32, beta, C, 32);
      //a5++;
    }
    /*
    printf("\ncblas_sscal count: %d\n", a0);
